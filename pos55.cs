...
arr = new string[6];
	...
	datum.Text=strx1;
	vrijeme.Text=strx2;
	new printanje(strx1,strx2,listView,sumaxy);
	listView.Items.Clear();
	suma.Text="";
	sumax=0.0f;
	}
...
private ListView listView;
string sumaxy;
public printanje(string str1,string str2,ListView listView,string sumaxy){
this.str1=str1;
this.str2=str2;
...
g.DrawString("Usluga",font1,redBrush,0,100);
g.DrawString("Kolicina",font1,redBrush,120,100);
g.DrawString("Cijena",font1,redBrush,0,113);
g.DrawString("Mjera",font1,redBrush,50,113);
g.DrawString("Pdv",font1,redBrush,100,113);
g.DrawString("Iznos",font1,redBrush,130,113);
g.DrawString("------------------------------------",font1,redBrush,0,126);
int p=0;
for(int ii=0;ii<this.listView.Items.Count;ii++){
	g.DrawString(this.listView.Items[ii].SubItems[0].Text.ToString(),font1,redBrush,0,139+p);
	g.DrawString(this.listView.Items[ii].SubItems[1].Text.ToString(),font1,redBrush,120,139+p);
	g.DrawString(this.listView.Items[ii].SubItems[2].Text.ToString(),font1,redBrush,0,154+p);
	g.DrawString(this.listView.Items[ii].SubItems[3].Text.ToString(),font1,redBrush,50,154+p);
	g.DrawString(this.listView.Items[ii].SubItems[4].Text.ToString(),font1,redBrush,100,154+p);
	g.DrawString(this.listView.Items[ii].SubItems[5].Text.ToString(),font1,redBrush,130,154+p);
	
	p+=26;
	}
g.DrawString("------------------------------------",font1,redBrush,0,154+p);
g.DrawString("Ukupno",font1,redBrush,0,167+p);
g.DrawString(this.sumaxy,font1,redBrush,130,167+p);
}
...
{	
	...
	form7.Disposed+= new EventHandler(Form1_FormClosed);
