...
private Label sifra,id1_label,id2_label,mjera1_label,mjera2_label,usluga;
...
private void InitalizeComponent()
{
	...
	id2_label=new Label();
	id2_label.Location=new Point(30,190);
	...
	id2_text.Location=new Point(130,190);
	...
	mjera2_label.Location=new Point(30,230);
	...
	mjera2_text.Location=new Point(130,230);
