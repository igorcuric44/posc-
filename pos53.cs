...
class printanje {
string str1,str2;
public printanje(string str1,string str2){
this.str1=str1;
this.str2=str2;
print();
}
...
g.DrawString("Datum ", font, redBrush,0,0);
g.DrawString(this.str1, font, redBrush,100,0);
g.DrawString("Vrijeme ", font, redBrush,0,15);
g.DrawString(this.str2, font, redBrush,100,15);
