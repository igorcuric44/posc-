...
private void tipka1_click(object sender,EventArgs e) {
	...
	string usluga=Convert.ToString(usluga_text);
	int id1=Convert.ToInt32(id1_text);
	float mjera1=Convert.ToSingle(mjera1_text);
	float cijena1=Convert.ToSingle(cijena1_text);
	int id2=Convert.ToInt32(id2_text);
	float mjera2=Convert.ToSingle(mjera2_text);
	float cijena2=Convert.ToSingle(cijena2_text);
