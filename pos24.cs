...
private void InitalizeComponent()
{
	...
	sifra_text.Text="sifra";
	sifra_text.Font=font;
	this.Controls.Add(sifra_text);

/*
	id1=new Button();
	id1.Location=new Point(30,100);
	id1.Size=new Size(100,30);
	id1.Text="sifra 1";
	id1.Font=font1;
...
*/
	lv1=new ListView();
	lv1.Location=new Point(30,100);
	lv1.Size=new Size(300,200);
	lv1.Text="sifra 1";
	lv1.Font=font1;
	...
	lv2=new ListView();
	lv2.Location=new Point(450,100);
	lv2.Size=new Size(300,200);
	lv2.Text="sifra 1";
	lv2.Font=font1;
...
if(lv2.SelectedItems.Count == 0)
    return;    MessageBox.Show(this,lv2.SelectedItems[0].SubItems[0].Text.ToString()+" "+lv2.SelectedItems[0].SubItems[1].Text.ToString()+" "+lv2.SelectedItems[0].SubItems[2].Text.ToString());  
}   
