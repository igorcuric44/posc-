...
private void tipka1_click(object sender,EventArgs e) {
	...
	try
	{
		...
		id2,mjera2,cijena2) values (1,'Kava',1,0.007,6.0,0,0,0);";  
		cmd.ExecuteNonQuery();
...
private Label poduzece_label,ime_label,prezime_label,oib_label,telefon_label,adresa_label;
private TextBox poduzece_text,ime_text,prezime_text,oib_text,telefon_text,adresa_text;
...
private void InitalizeComponent()
{
	...
	oib_label=new Label();
	oib_label.Location=new Point(30,190);
	oib_label.Size=new Size(100,30);
	oib_label.Text="Oib";
	oib_label.Font=font;
	...
	oib_text=new TextBox();
	oib_text.Location=new Point(170,190);
	oib_text.Size=new Size(100,30);
	oib_text.Text="";
	oib_text.Font=font;
	...
	telefon_label.Location=new Point(30,230);
	...
	telefon_text.Location=new Point(170,230);
