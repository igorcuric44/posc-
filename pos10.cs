...
{	
	...
	if(bla1==null){
	bla1=new blagajna();
	this.FormClosed+=new FormClosedEventHandler(blagajna_closed);
	bla1.Show();
	}
	else {
...
private void tipka4_click(object sender,EventArgs e)
{
	...
	skladisnica skl1=new skladisnica();
	skl1.Show();

}

private void blagajna_closed(object sender,FormClosedEventArgs e)
{
	bla1=null;
