...
private Label sifra,id1_label,id2_label,mjera1_label;
private TextBox sifra_text,id1_text,id2_text,mjera1_text;
private Button id1;
...
private void InitalizeComponent()
{
	...
	Font font1=new Font("Verdana",10,FontStyle.Bold);
	...
	id1_label=new Label();
	id1_label.Location=new Point(30,70);
	...
	id1_text.Location=new Point(130,70);
	...
	mjera1_label.Location=new Point(30,110);
	...
	mjera1_text.Location=new Point(130,110);
	...
	id2_label=new Label();
	id2_label.Location=new Point(30,150);
	...
	id2_text.Location=new Point(130,150);
	...
	lv2.Size=new Size(300,300);
	lv2.Text="sifra 1";
	lv2.Font=font1;
	lv2.View = View.Details;
	lv2.FullRowSelect = true;
	lv2.GridLines = true;
	lv2.Columns.Add("Id", 100);
	lv2.Columns.Add("Artikl", 100);
	lv2.Columns.Add("Pdv", 100);
	lv2.GridLines = true;
	...
	tipka2=new Button();
	tipka2.Location=new Point(170,350);
	tipka2.Size=new Size(100,30);
	tipka2.Text="Odustani";
	tipka2.Font=font;
	tipka2.Click+=new EventHandler(tipka2_click);
...
id1_text.Text=lv2.SelectedItems[0].SubItems[0].Text.ToString();
}
if(radio2.Checked){
MessageBox.Show(this,lv2.SelectedItems[0].SubItems[0].Text.ToString()+" "+lv2.SelectedItems[0].SubItems[1].Text.ToString()+" "+lv2.SelectedItems[0].SubItems[2].Text.ToString()); 
id2_text.Text=lv2.SelectedItems[0].SubItems[0].Text.ToString();
}
