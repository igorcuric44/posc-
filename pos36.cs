...
private void txtInput_KeyPress(object sender ,KeyPressEventArgs e){
	...
	if(sx1!=0){
		str2=str1;
		sx2=Convert.ToInt32(str2);
		Console.WriteLine("str2={0} str1={1}",str2,str1);
		Console.WriteLine("sx2={0}",sx2);
	}
	...
	if(keyChar==13){
		...
		sx1=Convert.ToInt32(str1);
		Console.WriteLine("sx1={0}",sx1);
		arr = new string[6];
    	ListViewItem itm ;
		
		if(sx1!=0){
			sql="select * from sifrarnik where id="+sx1.ToString()+";";
			Console.WriteLine("str2={0} ===",str1);
		}else
		{
			sql="select * from sifrarnik where id="+sx2.ToString()+";";
