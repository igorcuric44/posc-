...
arr = new string[7];
		...
		arr[3]=string.Format("{0:0.00}",rdr[4]);
	...
	Console.WriteLine("");
	Console.WriteLine(listView.Items[ii].SubItems[1].Text+" ");
	Console.WriteLine(listView.Items[ii].SubItems[2].Text+" ");	
	Console.WriteLine("");
	...
	try
		...
		sql=@"select * from skladiste where id in
			(select id1 from sifrarnik where id="+listView.Items[ii].SubItems[6].Text.ToString()+");";
		...
		Console.WriteLine(rdr.GetFloat(4));	
		Console.WriteLine(rdr.GetFloat(5));	
